...
import { DependencyCtorOrFunctor, StringOrBase } from './types';

/**
 * Decorator: Specifies a custom Invoker for the decorated item.
 */
export function invoker<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase>>(
 ...
 */
export interface Invoker<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase>> {
  /**
