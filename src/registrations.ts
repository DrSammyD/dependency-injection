...
import { DependencyCtorOrFunctor, StringOrDependencyCtor, StringOrBase } from './types';

/**
 * Decorator: Specifies a custom registration strategy for the decorated
 * class/function.
 */
export function registration<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase>>(
 ...
 * lifetime.
 */
export function transient<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase>>(
  key?: StringOrDependencyCtor<TBase, TImpl, TArgs>): any {
...
export function singleton<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase>>(
  key?: StringOrDependencyCtor<TBase, TImpl, TArgs>, registerInChild?: boolean): any;
export function singleton<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase>>(
  keyOrRegisterInChild?: StringOrDependencyCtor<TBase, TImpl, TArgs> | boolean, registerInChild: boolean = false) {
 ...
 */
export interface Registration<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase>> {
  /**
 ...
 */
export class TransientRegistration<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase>>
 ...
 */
export class SingletonRegistration<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase>>
  implements Registration<TBase, TArgs, TImpl> {
  /** @internal */
   ...
   */
  constructor(
    keyOrRegisterInChild?: StringOrDependencyCtor<TBase, TImpl, TArgs> | boolean,
