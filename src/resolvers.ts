...
export type StrategyFunctor<
  ...
  > = (
    container?: Container,
    ctor?: StringOrDependencyCtorOrFunctor<TBase, TArgs, TImpl>,
...
export class StrategyResolver<
   ...
   * @return Returns the resolved object.
   */
  public get(container: Container, key: StringOrDependencyCtor<TBase, TImpl, TArgs>) {
 ...
 */
@resolver()
export class Lazy<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase> = StringOrBase<TBase>> {
  /** @internal */
  public _key: StringOrDependencyCtor<TBase, TImpl, TArgs>;

  /**
   * Creates an instance of the Lazy class.
   * @param key The key to lazily resolve.
   */
  constructor(key: StringOrDependencyCtor<TBase, TImpl, TArgs>) {
    this._key = key;
  }
   ...
   */
  public static of<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase> = StringOrBase<TBase>>(key: any) {
 ...
 */
@resolver()
export class All<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase> = StringOrBase<TBase>> {
  /** @internal */
  public _key: StringOrDependencyCtor<TBase, TImpl, TArgs>;
   ...
   */
  public static of<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase> = StringOrBase <TBase>>(
 ...
 */
@resolver()
export class Optional<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase> = StringOrBase<TBase>> {
  /** @internal */
  public _key: StringOrDependencyCtor<TBase, TImpl, TArgs>;
   ...
   * should be checked.
   */
  constructor(key: StringOrDependencyCtor<TBase, TImpl, TArgs>, checkParent: boolean = true) {
    this._key = key;
 ...
 */
@resolver()
export class Parent<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase> = StringOrBase<TBase>> {
  /** @internal */
  public _key: StringOrDependencyCtor<TBase, TImpl, TArgs>;
  ...
  public static of<TBase,
    TArgs extends Array<any>,
    TImpl extends StringOrBase<TBase> = StringOrBase<TBase>>(key: any): Parent<TBase, TArgs, TImpl> {
 ...
 */
@resolver()
export class Factory<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase> = StringOrBase<TBase>> {
  /** @internal */
  public _key: StringOrDependencyCtorOrFunctor<TBase, TArgs, TImpl>;

  /**
   * Creates an instance of the Factory class.
   * @param key The key to resolve from the parent container.
   */
  constructor(key: StringOrDependencyCtorOrFunctor<TBase, TArgs, TImpl>) {
    this._key = key;
  }
 ...
 */
@resolver()
export class NewInstance<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase> = StringOrBase<TBase>> {
  /** @internal */
  public key: StringOrDependencyCtorOrFunctor<TBase, TArgs, TImpl>;
  /** @internal */
  public asKey: StringOrDependencyCtorOrFunctor<TBase, TArgs, TImpl>;
  /** @internal */
   ...
   */
  constructor(key: StringOrDependencyCtorOrFunctor<TBase, TArgs, TImpl>, ...dynamicDependencies: TArgs[number][]) {
    this.key = key;
    this.asKey = key;
   ...
   */
  public as(key: StringOrDependencyCtorOrFunctor<TBase, TArgs, TImpl>) {
    this.asKey = key;
    return this;
  }
...
export function getDecoratorDependencies<
  TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase> = StringOrBase<TBase>>(
 ...
 */
export function newInstance<TBase, TArgs extends Array<any>, TImpl extends StringOrBase<TBase> = StringOrBase<TBase>>(
  asKeyOrTarget?: StringOrDependencyCtor<TBase, TImpl, TArgs> & { inject?: TArgs[number][] },
